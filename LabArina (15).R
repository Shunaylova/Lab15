# renv::init() # инициализаци€ виртуального окружени€
...
# фиксируем этот список в .lock-файле дл€ возможности восстановлени€
# renv::restore() # команда отктитьс€ к предыдушему удачному обновлени€ библиотек

# ------------------- 
# Ћабораторна€ работа є15:
# ћашины опорных векторов (SVM).

# ---------- «адание --------------
# примените SVM к дата-сету Iris дл€ решени€ задачи классификации цветков разного вида

#прогружаем необходимые пакеты
library(e1071)
library(ROCR)

#измен€ем рабочий каталог 
